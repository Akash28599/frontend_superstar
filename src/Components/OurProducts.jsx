...
const OurProducts = () => {
  ...
  // const { ourProducts: data, fetchOurProducts, ourProductsLoading: loading } = useHomeStore()
  //  useEffect(() => {
  ...
  // const coco = data?.find((it) => !it.title_description) || null;
  // const products = data?.filter((it) => it.title_description);
